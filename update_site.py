...
KNOWN_CITIES = [
    'Санкт-Петербург', 'Нижний Новгород', 'Ростов-на-Дону', 'Набережные Челны',
    'Йошкар-Ола', 'Улан-Удэ', 'Петропавловск-Камчатский',
    'Москва', 'Владивосток', 'Хабаровск', 'Новосибирск', 'Екатеринбург',
    'Казань', 'Краснодар', 'Челябинск', 'Уфа', 'Красноярск', 'Пермь',
    'Волгоград', 'Воронеж', 'Саратов', 'Тюмень', 'Иркутск', 'Барнаул',
    'Ульяновск', 'Ижевск', 'Ярославль', 'Владимир', 'Севастополь', 'Чита',
    'Чебоксары', 'Калининград', 'Томск', 'Кемерово', 'Рязань', 'Тольятти',
    'Астрахань', 'Пенза', 'Липецк', 'Киров', 'Махачкала', 'Оренбург',
    'Симферополь', 'Сочи', 'Якутск', 'Магадан', 'Мурманск',
    'Архангельск', 'Петрозаводск', 'Курск', 'Тула', 'Смоленск', 'Тверь',
    'Иваново', 'Брянск', 'Белгород', 'Вологда', 'Новороссийск',
    'Минск', 'Алматы', 'Астана', 'Ташкент', 'Бишкек', 'Ереван', 'Тбилиси',
    'Баку', 'Кишинёв', 'Берлин',
]
...
for c in companies:
    ...
    companies_out.append({
        ...
        'reviewsList': c_reviews, 'city': extract_city(c['region'], c['description']),
    })
